...
function CoachLayout({ children }) {
  ...
  const isGroupActive = (groupId) => location.pathname.includes(`/coach/groups/${groupId}`)
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800">
          <span className="text-lg font-semibold text-gray-900 dark:text-white">Coach</span>
          <button
            ...
            <div key={group.id} className="space-y-1">
              ...
              >
                <div className="flex items-center">
                  ...
                  <span className="font-medium truncate max-w-[140px]">{group.name}</span>
                </div>
                <svg
              ...
              {expandedGroups[group.id] && (
                <div className="ml-4 pl-4 border-l border-gray-200 dark:border-gray-700 space-y-1">
                  {/* Programmation */}
                  <Link
                    to={`/coach/groups/${group.id}/programmation`}
                    className={`flex items-center px-3 py-2 text-sm rounded-md ${
                      isActive(`/coach/groups/${group.id}/programmation`)
                        ? 'bg-emerald-100 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300'
                  ...
                  <Link
                    ...
                    className={`flex items-center px-3 py-2 text-sm rounded-md ${
                      location.pathname.includes(`/coach/groups/${group.id}/sessions`)
                        ? 'bg-emerald-100 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300'
                        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'
                    }`}
                    onClick={() => setSidebarOpen(false)}
                  ...
                  {/* Axes de travail */}
                  <Link
                    to={`/coach/groups/${group.id}/work-leads`}
                    className={`flex items-center px-3 py-2 text-sm rounded-md ${
                      location.pathname.includes(`/coach/groups/${group.id}/work-leads`)
                        ? 'bg-emerald-100 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300'
                        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'
                    }`}
                    onClick={() => setSidebarOpen(false)}
                  ...
                  <Link
                    ...
                    className={`flex items-center px-3 py-2 text-sm rounded-md ${
                      isActive(`/coach/groups/${group.id}/projects`)
                        ? 'bg-emerald-100 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300'
                        : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'
                    }`}
                    onClick={() => setSidebarOpen(false)}
