...
function SuperCoachLayout({ children }) {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700">
          <span className="text-lg font-semibold text-gray-900 dark:text-white">Super Coach</span>
          <button
        ...
        <nav className="p-4 space-y-2">
          ...
          <Link
            to="/super-coach/work-lead-models"
            className="flex items-center px-4 py-2 text-gray-700 dark:text-gray-200 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700"
            onClick={() => setSidebarOpen(false)}
          >
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center">
              ...
              <div className="relative" ref={userMenuRef}>
                <button
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-full text-white font-semibold text-sm bg-emerald-600 hover:bg-emerald-700"
                >
                  {getInitials()}
                </button>
...
export default SuperCoachLayout
